...
<body>
    ...
    <nav class="navbar navbar-dark" style="background-color: black;">
        ...
        <ul class="nav justify-content-end">
            <li class="nav-item">
                <a class="nav-link active" href="debaterhomepage.html" style="color:white;">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="debaterAccount.php" style="color:white;">Account</a>
            </li>
            <li class="nav-item">
    ...
    <?php
        ...
        if ($conn->query($sql) === TRUE) {
         ...
         $sql = "SELECT * FROM USER WHERE USERS.UserID = '$DebaterID';";
    ...
    <div class="container" style="width: 80%; margin:3% auto auto auto;">
        ...
        <div class="left">
            ...
            <div class="informations">
                <p> <span> UserID: &ensp; &ensp;</span><?php echo $DebaterID; ?> </p>
        ...
        <div class="right">
            <?php
            $sql = "SELECT * FROM SPEECHES WHERE (DebaterID = '$DebaterID');";
